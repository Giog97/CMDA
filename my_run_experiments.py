# Modificato per poter usare con il parser mit_b1 e mit_b2
import argparse
import json
import os
import subprocess
...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', type=str, choices=['mit_b3', 'mit_b4', 'mit_b5', 'mit_b0', 'mit_b1', 'mit_b2'], default='') # Qui è dove scegliamo la Backbone: aggiunti anche gli altri mit_b
