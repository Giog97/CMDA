...
data = pd.read_csv('loss_l2_source_RGB_EVENT.csv')
...
plt.plot(iterazioni, loss, marker='.', linestyle='-', color='red')

# Aggiunge titoli e etichette per chiarezza
plt.title('Andamento di loss_l2_RGBsource_EVENTsource', fontsize=16)
...
nome_file_grafico = 'grafico_loss_l2_RGBsource_EVENTsource.png'
