...
data = pd.read_csv('loss_l2_source_target_fusion.csv')
...
plt.plot(iterazioni, loss, marker='.', linestyle='-', color='purple')

# Aggiunge titoli e etichette per chiarezza
plt.title('Andamento di loss_l2_source_target_fusion', fontsize=16)
...
nome_file_grafico = 'grafico_lossL2_source_target_fusion.png'
