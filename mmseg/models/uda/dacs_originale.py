...
@UDA.register_module()
class DACS_originale(UDADecoratorFusion): # aggiunto '_originale'

    def __init__(self, **cfg):
        super(DACS_originale, self).__init__(**cfg) # aggiunto '_originale'
        self.local_iter = 0
...
@UDA.register_module()
class OrgDACS_originale(UDADecorator): # aggiunto '_originale'

    def __init__(self, **cfg):
        super(OrgDACS_originale, self).__init__(**cfg) # aggiunto '_originale'
        self.local_iter = 0
        self.max_iters = cfg['max_iters']
        self.alpha = cfg['alpha']
        self.pseudo_threshold = cfg['pseudo_threshold']
