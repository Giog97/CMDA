...
class BaseDecodeHead_originale(BaseModule, metaclass=ABCMeta): # aggiunto '_originale'
    ...
    def __init__(self,
        ...
        super(BaseDecodeHead_originale, self).__init__(init_cfg) # aggiunto '_originale'
...
class BaseDecodeHeadFusion_originale(BaseModule, metaclass=ABCMeta): # aggiunto '_originale'
    """Base class for BaseDecodeHead.
    ...
    def __init__(self,
        ...
        super(BaseDecodeHeadFusion_originale, self).__init__(init_cfg) # aggiunto '_originale'
        self._init_inputs(in_channels, in_index, input_transform)
        self.channels = channels
        self.num_classes = num_classes
        self.dropout_ratio = dropout_ratio
