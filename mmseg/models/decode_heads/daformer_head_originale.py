...
# modificato il seguente import per avere 'decode_head_originale'
from .decode_head_originale import BaseDecodeHead_originale, BaseDecodeHeadFusion_originale # modificato BaseDecodeHead_originale e BaseDecodeHeadFusion_originale
...
class DAFormerHead_originale(BaseDecodeHead_originale):  # aggiunto '_originale', e BaseDecodeHead_originale

    def __init__(self, **kwargs):
        super(DAFormerHead_originale, self).__init__(  # aggiunto '_originale'
...
@HEADS.register_module()
class DAFormerHeadFusion_originale(BaseDecodeHeadFusion_originale): # aggiunto '_originale', e BaseDecodeHeadFusion_originale

    def __init__(self, **kwargs):
        super(DAFormerHeadFusion_originale, self).__init__( # aggiunto '_originale'
            input_transform='multiple_select', **kwargs)
