...
class EncoderDecoder_originale(BaseSegmentor): # aggiunto '_originale'
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(EncoderDecoder_originale, self).__init__(init_cfg)
...
@SEGMENTORS.register_module()
class EventsEncoderDecoder_originale(BaseSegmentorEvents): # aggiunto '_originale'
    """Encoder Decoder segmentors.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(EventsEncoderDecoder_originale, self).__init__(init_cfg) # aggiunto '_originale'
        if pretrained is not None:
            assert backbone.get('pretrained') is None, \
                'both backbone and segmentor set pretrained weight'
            backbone.pretrained = pretrained
...
@SEGMENTORS.register_module()
class FusionEncoderDecoder_originale(BaseSegmentorFusion): # aggiunto '_originale'
    """Encoder Decoder segmentors.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(FusionEncoderDecoder_originale, self).__init__(init_cfg) # aggiunto '_originale'
    ...
    def extract_feat(self, image, events, img_self_res=None, cfg=None): # originale
        """Extract features from images."""
    ...
    def forward_train(self, inputs, gt_semantic_seg, seg_weight=None, return_feat=False, cfg=None): # originale
        """Forward function for training.
