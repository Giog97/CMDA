...
class DSECDataset_originale(Dataset): #aggiunto '_originale'
...
if __name__ == '__main__':
    ...
    dataset = DSECDataset_originale(dataset_txt_path='D:/研究生/Python/Night/DSEC_dataset/night_test_labels_dataset.txt',
